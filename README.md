...
`v0.1` tag predates the live-server fixes, so pin to `v0.3.0` or later:

```bash
pip install "dayshape-python-sdk @ git+https://github.com/Grant-Thornton-Advisors-NL/dayshape-python-sdk@v0.3.0"
```
